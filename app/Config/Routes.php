...
// $routes->get('cek-nilai/(:num)', 'Home::cek_nilai/$1');
// $routes->get('cek-nilai-loop/(:num)', 'Home::cek_nilai_loop/$1');
...
$routes->get('/admin/hapus-temp/([a-zA-Z0-9]+)', 'Admin::hapus_peminjaman/$1');
...
$routes->get(
    '/admin/detail-peminjaman/(:segment)',
    'Admin::detail_peminjaman/$1'
);

$routes->get(
    '/admin/proses-pengembalian/(:segment)/(:segment)',
    'Admin::proses_pengembalian/$1/$2'
);

$routes->get(
    '/admin/data-transaksi-pengembalian',
    'Admin::data_transaksi_pengembalian'
);

$routes->get('admin/laporan', 'Admin::laporan');
$routes->get('admin/cetak-laporan-buku', 'Admin::cetakLaporanBuku');
$routes->get('admin/cetak-laporan-anggota', 'Admin::cetakLaporanAnggota');
$routes->get('admin/cetak-laporan-peminjaman', 'Admin::cetakLaporanPeminjaman');
$routes->get('admin/cetak-laporan-pengembalian', 'Admin::cetakLaporanPengembalian');